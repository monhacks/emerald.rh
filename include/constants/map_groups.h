...
#define MAP_LITTLEROOT_TOWN_NEW_HOUSE            (5 | (1 << 8))
...
// gMapGroup_IndoorPalletCity
#define MAP_PALLET_CITY_PLAYER_HOUSE_ENTRANCE     (0 | (34 << 8))
#define MAP_PALLET_CITY_PLAYER_HOUSE_APARTMENT    (1 | (34 << 8))
#define MAP_PALLET_CITY_PLAYER_HOUSE_FIRST_FLOOR  (2 | (34 << 8))
#define MAP_PALLET_CITY_PLAYER_HOUSE_SECOND_FLOOR (3 | (34 << 8))
