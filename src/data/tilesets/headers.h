...
const struct Tileset gTileset_gTileset_Player_Room =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_gTileset_Player_Room,
    .palettes = gTilesetPalettes_gTileset_Player_Room,
    .metatiles = gMetatiles_gTileset_Player_Room,
    .metatileAttributes = gMetatileAttributes_gTileset_Player_Room,
    .callback = NULL,
};

const struct Tileset gTileset_PalletCity =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_PalletCity,
    .palettes = gTilesetPalettes_PalletCity,
    .metatiles = gMetatiles_PalletCity,
    .metatileAttributes = gMetatileAttributes_PalletCity,
    .callback = NULL,
};
