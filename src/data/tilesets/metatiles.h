...
const u16 gMetatiles_gTileset_Player_Room[] = INCBIN_U16("data/tilesets/secondary/player_room/metatiles.bin");
const u16 gMetatileAttributes_gTileset_Player_Room[] = INCBIN_U16("data/tilesets/secondary/player_room/metatile_attributes.bin");

const u16 gMetatiles_PalletCity[] = INCBIN_U16("data/tilesets/secondary/pallet_city/metatiles.bin");
const u16 gMetatileAttributes_PalletCity[] = INCBIN_U16("data/tilesets/secondary/pallet_city/metatile_attributes.bin");
